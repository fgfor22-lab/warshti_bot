...
void main() async {
  // -----------------------------------------------------
  // 0. تشغيل خادم وهمي على بورت 8080 لإرضاء منصة Back4App
  // -----------------------------------------------------
    ...
    if (data == 'role_customer' || data == 'role_technician') {
      ...
      if (hasSavedInfo) {
        ...
        var savedInfoMarkup = InlineKeyboardMarkup(inlineKeyboard: [
          [InlineKeyboardButton(text: 'استخدام بياناتي المحفوظة ✅', callbackData: 'use_saved')],[InlineKeyboardButton(text: 'تسجيل بيانات جديدة 🔄', callbackData: 'new_reg')]
        ]);
        ...
        teledart.sendMessage(chatId, '✅ تم اختيار: *$roleName*\n\n📝 *الخطوة 1:* يرجى كتابة اسمك الكامل (أو اسم المحل):', parseMode: 'Markdown');
      }
    }
      ...
      teledart.sendMessage(chatId, 'تم استرجاع معلوماتك بنجاح ✅\n\n🗂️ *الخطوة الأخيرة:* اختر القسم المناسب لك:', replyMarkup: categoriesMarkup, parseMode: 'Markdown');
    }
      ...
      teledart.sendMessage(chatId, '✅ تم اختيار: *$roleName*\n\n📝 *الخطوة 1:* يرجى كتابة اسمك الكامل الجديد:', parseMode: 'Markdown');
    }
      ...
      teledart.sendMessage(chatId, '📍 المحافظة المختارة: *$selectedGov*\n\n📞 *الخطوة 3:* اكتب رقم هاتفك للتواصل:', parseMode: 'Markdown');
    }
      ...
      if (usersData[chatId]!['role'] == 'role_customer') {
        ...
        teledart.sendMessage(chatId, '🎯 القسم المختار: *$selectedCategory*\n\n✍️ *الخطوة الأخيرة:* اكتب مشكلتك أو العطل بالتفصيل:', parseMode: 'Markdown');
      } else {
        userStates[chatId] = 'tech_ready'; 
        teledart.sendMessage(chatId, '🎉 *تم تسجيلك كفني بنجاح!*\n\n⏳ *أنت الآن جاهز لاستقبال الطلبات الخاصة بمحافظتك وقسمك فقط...*', parseMode: 'Markdown');
      }
    }
      ...
      if (activeRequests[customerId] == true) {
        ...
        teledart.sendMessage(chatId, '⚠️ عذراً، هذا الطلب تم الاتفاق عليه مسبقاً مع فني آخر.');
      }
    }
  ...
  teledart.onMessage(entityType: '*').listen((message) {
    ...
    if (text == 'الدعم الفني 📞') {
      teledart.sendMessage(chatId, '📞 *تواصل مع إدارة المنصة:*\n\nحساب التليجرام: @r_tk_n\nرقم الهاتف: 07807389172\n\nنحن في خدمتك لأي استفسار أو مشكلة!', parseMode: 'Markdown');
      return;
    }
    ...
    if (text.startsWith('/') || text == 'القائمة الرئيسية 🏠') return;if (userStates[chatId] == 'ask_name') {
      ...
      userStates[chatId] = 'ask_category';
      var categoriesMarkup = getCategoriesMarkup();
      teledart.sendMessage(chatId, '🗂️ *الخطوة 4:* اختر القسم المناسب لك:', replyMarkup: categoriesMarkup, parseMode: 'Markdown');
    }
